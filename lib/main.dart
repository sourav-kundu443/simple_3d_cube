...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    obj.fragments[0].faces[2].materialIndex = 1;
    obj.fragments[0].faces[3].materialIndex = 1;

    obj.materials[0] = FSp3dMaterial.grey.deepCopy()
      ..strokeColor = const Color.fromARGB(255, 0, 0, 255);

    obj.materials[1] = FSp3dMaterial.red.deepCopy()
      ..strokeColor = const Color.fromARGB(240, 240, 8, 240);

    obj.materials[1] = FSp3dMaterial.black.deepCopy()
      ..strokeColor = const Color.fromARGB(240, 240, 8, 240);
          ...
          body: Column(
            children: [
              Sp3dRenderer(
                ...
                Sp3dCamera(Sp3dV3D(0, 0, 6000), 6000),
